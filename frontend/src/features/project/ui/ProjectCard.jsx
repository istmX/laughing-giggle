  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <h3 className="text-card-title tracking-card-title font-700 text-ink line-clamp-2">
          {name || 'Untitled Project'}
        </h3>
        <span className={`rounded-full px-2.5 py-1 text-caption tracking-caption font-400 uppercase ${getStatusColor()}`}>
          {status || 'Draft'}
        </span>
      </div>
      
      <div className="flex items-center text-body-sm tracking-body-sm font-330 text-ink-muted">
