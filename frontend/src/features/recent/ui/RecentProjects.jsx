    ...
    <div className="flex-1 flex flex-col h-full bg-background relative overflow-hidden">
      ...
      <div className="shrink-0 border-b border-hairline bg-background px-4 py-4 sm:px-6 md:px-8 lg:px-10 z-20">
        <div className="mx-auto w-full max-w-7xl">
          <div className="relative overflow-hidden rounded-[var(--radius-lg)] bg-block-cream px-4 py-5 sm:px-6 sm:py-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-ink-soft">Project activity</p>
              <h1 className="mt-2 text-[32px] md:text-[40px] font-[480] tracking-[-0.04em] text-ink leading-[1.1]">
                Recent Projects
              </h1>
              <p className="mt-2 block w-full max-w-[60ch] text-[14px] leading-6 text-ink/70">Pick up right where you left off.</p>
            </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6 lg:px-10 lg:py-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <div className="mx-auto w-full max-w-7xl pb-16">
          ...
          {projects.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-[var(--radius-lg)] bg-block-cream px-6 py-16 text-center">
              <div className="mb-6 flex size-14 items-center justify-center rounded-full border border-ink/10 bg-white/60">
                <Folder className="size-6 text-ink" />
              </div>
              <h3 className="mb-2 text-[22px] font-[var(--font-weight-540)] tracking-[-0.03em] text-ink">No projects yet</h3>
                    ...
                    {groupProjects.map(project => {
                      ...
                      if (layout === 'grid') {
                        return (
                            ...
                            <div className="relative h-16 shrink-0 bg-block-coral" aria-hidden="true">
